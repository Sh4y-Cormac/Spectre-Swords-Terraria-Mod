using SpectreSwords.Content.Items.Materials; // Using our Materials folder
using Terraria;
using Terraria.GameContent.Creative;
using Terraria.ID;
using Terraria.ModLoader;
using Microsoft.Xna.Framework; // game dev library for c# and others

namespace SpectreSwords.Content.Items.Weapons.Melee // where the code is located
{
    public class ForgottenSword : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.scale = 5f; // Multiplicator of item size, for example is you set this to 2f our sword will be biger twice. IMPORTANT: If you are using numbers with floating point, write "f" in their end, like 1.5f, 3.14f, 2.1278495f etc.
            Item.rare = ItemRarityID.Blue; // The color of item's name in game. Check https://terraria.wiki.gg/wiki/Rarity
        
            // Combat properties
            Item.damage = 75; // Item damage
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient<CardDeck>(5); // We are using custom material for the craft, 7 Steel Shards
        ...
        public override void MeleeEffects(Player player, Rectangle hitbox)
        {
            if (Main.rand.NextBool(3)) // With 1/3 chance per tick (60 ticks = 1 second)...
            {
                ...
                DustID.BlueFairy, // Dust type. Check https://terraria.wiki.gg/wiki/Dust_IDs
        ...
        {
            if (Main.rand.NextBool(2)) // 1/2 chance, or 50% in other words
            {
                target.AddBuff(BuffID.OnFire, // Adding Poisoned to target
